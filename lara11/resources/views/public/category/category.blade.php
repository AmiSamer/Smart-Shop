        ...
        <div class="container">
            ...
            <div class="single-pro">
                ...
                <div class="col-md-3 product-men">
                    <div class="men-pro-item simpleCart_shelfItem">
                        <div class="men-thumb-item">
                            <img src="{{asset($categoryProduct->main_image)}}" alt="" class="pro-image-front" height="250">
                            <img src="{{asset($categoryProduct->main_image)}}" alt="" class="pro-image-back" height="250">
                            <div class="men-cart-pro">
                                <div class="inner-men-cart-pro">
                        ...
                        <div class="item-info-product ">
                            ...
                            <div class="info-product-price">
                                <span class="item_price">Tk. {{$categoryProduct->coupon_price}}</span>
                                <del>Tk. {{$categoryProduct->product_price}}</del>
                            </div>
                            <a href="#" class="item_add single-item hvr-outline-out button2">Add to cart</a>
                        </div>
                    </div>
