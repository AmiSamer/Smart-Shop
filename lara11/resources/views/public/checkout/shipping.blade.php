        ...
        <div class="row">
            <div class="col-md-offset-2 col-lg-8">
              <h1 class="text-center">Dear {{Session::get('customerName')}}<br>Please provide your shipping info.</h1>
                <small class="text-danger">If shipping info is different, then please edit the form</small>
                <form action="{{route('new-shipping')}}" method="post">
                    ...
                    <div class="form-group">
                        <button type="submit" name="btn" class="btn btn-success btn-lg">save Shipping Info</button>
                    </div>
                </form>
            </div>
        </div>
