                    ...
                    <div class="resp-tabs-container">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{asset($product->main_image)}}" alt="" class="pro-image-front" height="250">
                                        <img src="{{asset($product->main_image)}}" alt="" class="pro-image-back" height="250">
                        ...
                        <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{asset($specialProduct->main_image)}}" alt="" class="pro-image-front" height="250">
                                        <img src="{{asset($specialProduct->main_image)}}" alt="" class="pro-image-back" height="250">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="single.html" class="link-product-add-cart">Quick View</a>
                                            </div>
